...
function o(e, o) {
    t("正在加载数据"), wx.login({
        success: function(t) {
            var c = t.code;
            c ? wx.request({
                url: getApp().globalData.host + "/notice/login",
                data: {
                    code: c,
                    user_data: ""
                },
                method: "POST",
                success: function(t) {
                    if (a(), console.log("res =============== : "), console.log(t), t.data.data && t.data.data.access_token) {
                        wx.setStorageSync("accessToken", t.data.data.access_token);
                        var c = t.data.data.uname;
                        wx.setStorageSync("userInfo", {
                            nickName: c
                        }), "function" == typeof e && e();
                    } else -1 == t.data.sta && 10 == t.data.errcode ? i(e, o) : n("服务器登陆失败，请退出后重新登录");
                },
                fail: function(e) {
                    n("服务器登陆失败，请退出后重新登录");
                }
            }) : n("获取微信登录状态失败，请退出后重新登录");
        },
        fail: function(e) {
            n("微信登陆失败，请退出后重新登录");
        }
    ...
    wx.login({
        success: function(a) {
            ...
            i && wx.getUserInfo({
                ...
                success: function(t) {
                    var a = t.userInfo;
                    wx.setStorageSync("userInfo", a), wx.request({
                        url: getApp().globalData.host + "/notice/login",
                        data: {
                            code: i,
                            user_data: t
                        ...
                        method: "POST",
                        success: function(t) {
                            t.data.data && t.data.data.access_token ? (wx.setStorageSync("accessToken", t.data.data.access_token), 
                            "function" == typeof e && e()) : n("服务器登陆失败，请退出后重新登录");
                        },
                        fail: function(e) {
                            n("服务器登陆失败，请退出后重新登录");
                        }
                ...
                fail: function(a) {
                    if ("getUserInfo:fail scope unauthorized" == a.errMsg || "getUserInfo:fail auth deny" == a.errMsg || "getUserInfo:fail:scope unauthorized" == a.errMsg || "getUserInfo:fail:auth deny" == a.errMsg) {
                        var n = getCurrentPages(), i = n.length, c = !1;
                        console.log(n);
                        for (var s = 0; s < i; s++) "pages/auth/auth" == n[s].route && (c = !0);
                        if (c) return;
                        wx.navigateTo({
                            url: "/pages/auth/auth"
                        });
                    } else wx.openSetting && wx.showModal({
                        title: "提示",
                        content: "请授权重要通知使用用户信息，该操作仅会获取您的昵称和头像，请放心授权",
                        confirmText: "去授权",
                        cancelText: "不想授权",
                        confirmColor: "#1677d2",
                        cancelColor: "#999",
                        success: function(a) {
                            ...
                            }) : a.cancel && (console.log("用户点击取消"), "function" == typeof t && t());
                        }
                    });
                }
            });
...
function r(e, t, o) {
    if (console.log(o), (o && o.errMsg || "").indexOf("fail") >= 0) a(); else {
        var i = o && o.userInfo || s("userInfo");
        if (i.nickName || "") {
            var u = s("code");
            console.log("code ====== :"), console.log(u), c("userInfo", i), c("authButtonClicked", !0), 
            wx.request({
                url: getApp().globalData.host + "/notice/login",
                data: {
                    code: u,
                ...
                method: "POST",
                success: function(n) {
                    if (a(), n.data.data && n.data.data.access_token) {
                        var i = n.data.data.uname, s = n.data.data.upic, u = n.data.data.phone;
                        wx.setStorage({
                            key: "accessToken",
                            data: n.data.data.access_token,
                            success: function(t) {
                                "function" == typeof e && e(), c("userInfo", {
                                    nickName: i,
                                    avatarUrl: s,
                                    phone: u
                                });
                            ...
                            fail: function(t) {
                                d.globalData.accessToken = t.data.data.access_token, d.globalData.userInfo = {
                                    nickName: i,
                                    avatarUrl: s,
                                    phone: u
                                }, "function" == typeof e && e();
                        ...
                        var g = n.data.msg;
                        (g.indexOf("40163") > 0 || g.indexOf("40029") > 0) && wx.login({
                            success: function(a) {
                                c("code", a.code), r(e, t, o);
                            }
                        }), "function" == typeof t && t();
                    }
                },
                fail: function(e) {
                    n("服务器登陆失败，请退出后重新登录"), "function" == typeof t && t();
                }
            });
        }
    }
...
function u(e, t, a, n) {
    wx.request({
        url: d.globalData.host + "/ads/v1/list",
        method: "GET",
        data: {
        ...
        success: function(i) {
            if (-500 != i.data.sta) {
                if (0 == i.data.sta) {
                    ...
                    e.setData({
                        adsList: c
                    }), console.log("=====   9999 "), console.log(e.data), console.log(e.data.adsList), 
                    "function" == typeof n && n(), g(c[0], a);
                }
            } else o(function() {
                u(e, t, a, n);
            });
...
function l(e, t) {
    console.log("xcx_hl_click  ==== :"), console.log(e), console.log(t), wx.reportAnalytics("xcx_hl_click", {
        ad_id: e.ad_id,
        ad_name: e.desc,
        from: t
    });
...
module.exports = {
    ...
    postFormId: function(e) {
        wx.request({
            url: getApp().globalData.host + "/notice/formid",
            data: {
                formid: e,
    ...
    buttonLogin: r,
    getAds: u,
    toAdDetail: function(e, t) {
        0 == e.type ? wx.navigateToMiniProgram({
            appId: e.appid,
            path: e.url
